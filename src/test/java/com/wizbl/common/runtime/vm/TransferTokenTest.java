...
public class TransferTokenTest {
    ...
    private static final DepositImpl deposit;
    ...
    private static final String DESCRIPTION = "AIPC";
    private static final String URL = "https://wizbl.com";
    ...
    public void TransferTokenTest()
        ...
        Assert.assertEquals(9, dbManager.getAccountStore().get(Hex.decode(TRANSFER_TO)).getAssetMapV2().get(String.valueOf(id)).longValue());
