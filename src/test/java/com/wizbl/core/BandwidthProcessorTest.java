...
import com.wizbl.core.db.BandwidthProcessor;
...
public class BandwidthProcessorTest {
  ...
  private static final String DESCRIPTION = "WBL";
  ...
  public void createCapsule() {
    ...
    dbManager.getAssetIssueStore().put(ByteArray.fromString(ASSET_NAME), assetIssueCapsule);
    dbManager.getAssetIssueV2Store().put(ByteArray.fromString("1"), assetIssueCapsule);

    AssetIssueCapsule assetIssueCapsuleV2 = new AssetIssueCapsule(getAssetIssueV2Contract());
    dbManager.getAssetIssueV2Store().put(ByteArray.fromString(ASSET_NAME_V2), assetIssueCapsuleV2);
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    com.wizbl.protos.Protocol.Transaction.Contract contract = com.wizbl.protos.Protocol.Transaction.Contract
            .newBuilder()
  ...
  public void testFree() throws Exception {
    ...
    AccountCapsule ownerCapsule = dbManager.getAccountStore().get(ByteArray.fromHexString(OWNER_ADDRESS));
    dbManager.getAccountStore().put(ownerCapsule.getAddress().toByteArray(), ownerCapsule);
    ...
    AccountCapsule ownerCapsuleNew = dbManager.getAccountStore().get(ByteArray.fromHexString(OWNER_ADDRESS));

    Assert.assertEquals(128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
            ownerCapsuleNew.getFreeNetUsage());
    Assert.assertEquals(1526647838L, ownerCapsuleNew.getLatestConsumeFreeTime());//slot
    ...
    Assert.assertEquals(1526647838L, dbManager.getDynamicPropertiesStore().getPublicNetTime());
    Assert.assertEquals(0L, ret.getFee());

    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(1526691038000L); // + 12h

    dbManager.consumeBandwidth(trx, trace);
    ownerCapsuleNew = dbManager.getAccountStore().get(ByteArray.fromHexString(OWNER_ADDRESS));

    Assert.assertEquals(64L + 128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            ownerCapsuleNew.getFreeNetUsage());
    Assert.assertEquals(1526691038L, ownerCapsuleNew.getLatestConsumeFreeTime()); // 1526647838L + 28800L/2
    Assert.assertEquals(1526691038000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(64L + 128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            dbManager.getDynamicPropertiesStore().getPublicNetUsage());
    Assert.assertEquals(1526691038L, dbManager.getDynamicPropertiesStore().getPublicNetTime());
    Assert.assertEquals(0L, ret.getFee());
  }
  ...
  public void testConsumeAssetAccount() throws Exception {
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(0);
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(1526647838000L);
    dbManager.getDynamicPropertiesStore().saveTotalNetWeight(10_000_000L);//only assetAccount has frozen balance
    ...
    Assert.assertEquals(1526647838L, assetCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(1526647838000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526647838L, ownerCapsuleNew.getLatestAssetOperationTime(ASSET_NAME));
    Assert.assertEquals(128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
            ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    // 128은 transaction의 serialized size임.
    Assert.assertEquals(128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
    ...
    ownerCapsuleNew = dbManager.getAccountStore().get(ByteArray.fromHexString(OWNER_ADDRESS));
    assetCapsuleNew = dbManager.getAccountStore().get(ByteArray.fromHexString(ASSET_ADDRESS));

    Assert.assertEquals(1526691038L, assetCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(1526691038000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526691038L, ownerCapsuleNew.getLatestAssetOperationTime(ASSET_NAME));
    Assert.assertEquals(64L + 128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    Assert.assertEquals(64L + 128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            ownerCapsuleNew.getFreeAssetNetUsageV2("1"));
  ...
  public void testConsumeAssetAccountV2() throws Exception {
    ...
    Assert.assertEquals(1526647838L, issuerCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(1526647838000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526647838L, ownerCapsuleNew.getLatestAssetOperationTimeV2(ASSET_NAME_V2));
    Assert.assertEquals(119L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0), // 119는 transaction의 serialized size임.
            issuerCapsuleNew.getNetUsage());
    Assert.assertEquals(119L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
    ...
    Assert.assertEquals(1526691038L, issuerCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(1526691038000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526691038L,
            ownerCapsuleNew.getLatestAssetOperationTimeV2(ASSET_NAME_V2));
    Assert.assertEquals(59L + 119L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            ownerCapsuleNew.getFreeAssetNetUsageV2(ASSET_NAME_V2));
    Assert.assertEquals(59L + 119L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            issuerCapsuleNew.getNetUsage());
    Assert.assertEquals(0L, ret.getFee());
  ...
  public void testConsumeOwner() throws Exception {
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(0);
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(1526647838000L);
    dbManager.getDynamicPropertiesStore().saveTotalNetWeight(10_000_000L);//only owner has frozen balance
    ...
    AccountCapsule assetCapsuleNew = dbManager.getAccountStore().get(ByteArray.fromHexString(ASSET_ADDRESS));

    Assert.assertEquals(128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
            ownerCapsuleNew.getNetUsage());
    Assert.assertEquals(1526647838000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526647838L, ownerCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(0L, ret.getFee());
    ...
    Assert.assertEquals(64L + 128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX / 2 * 3 : 0),
            ownerCapsuleNew.getNetUsage());
    Assert.assertEquals(1526691038000L, ownerCapsuleNew.getLatestOperationTime());
    Assert.assertEquals(1526691038L, ownerCapsuleNew.getLatestConsumeTime());
    Assert.assertEquals(0L, ret.getFee());
  }
  ...
  public void testUsingFee() throws Exception {
    ...
    long transactionFee =
            (128L + (dbManager.getDynamicPropertiesStore().supportVM() ? Constant.MAX_RESULT_SIZE_IN_TX : 0)) * dbManager.getDynamicPropertiesStore().getTransactionFee();
    Assert.assertEquals(transactionFee, dbManager.getDynamicPropertiesStore().getTotalTransactionCost());
    Assert.assertEquals(10_000_000L - transactionFee, ownerCapsuleNew.getBalance());
...
//    Assert.assertEquals(101220L, ret.getFee());
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    long byteSize = trx.getInstance().toBuilder().clearRet().build().getSerializedSize() + Constant.MAX_RESULT_SIZE_IN_TX;
    ...
    try {
      ...
      Assert.assertEquals(trace.getReceipt().getNetFee(), 0);
      Assert.assertEquals(trace.getReceipt().getNetUsage(), byteSize);
      // TransferContract의 경우에는 amount 기준으로 산정되는 수수료(fee)이외에는 별도의 수수료를 책정하지 않음.
//      AccountCapsule fromAccount = dbManager.getAccountStore().get(ByteArray.fromHexString(OWNER_ADDRESS));
//      Assert.assertNotNull(fromAccount);
