...
import com.wizbl.core.capsule.TxOutputCapsule;
...
public class TxOutputCapsuleTest {
  ...
  public void testTxOutputCapsule() {
    ...
    Assert.assertEquals(address, ByteArray.toHexString(txOutputCapsule.getTxOutput().getPubKeyHash().toByteArray()));
    ...
    Assert.assertEquals(address4, ByteArray.toHexString(txOutputCapsule2.getTxOutput().getPubKeyHash().toByteArray()));
    ...
    Assert.assertEquals("", ByteArray.toHexString(txOutputCapsule3.getTxOutput().getPubKeyHash().toByteArray()));
