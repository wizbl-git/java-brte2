...
import com.wizbl.common.overlay.message.*;
...
import static com.wizbl.core.net.message.MessageTypes.P2P_DISCONNECT;
import static com.wizbl.core.net.message.MessageTypes.P2P_HELLO;
