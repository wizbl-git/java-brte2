...
// TEST CLEAR -> 소수점 6자리여서 test 실패하던 것을 소수점 8자리로 변경하여 테스트 진행시 테스트 통과함.
@Slf4j
public class ExchangeCreateActuatorTest {
    ...
    public void initTest() {
        ...
        dbManager.getAccountStore().put(ownerAccountFirstCapsule.getAddress().toByteArray(), ownerAccountFirstCapsule);
        dbManager.getAccountStore().put(ownerAccountSecondCapsule.getAddress().toByteArray(), ownerAccountSecondCapsule);
    ...
    public void sameTokenNameCloseSuccessExchangeCreate() {
        ...
        accountCapsule.setBalance(10000_0000_0000L);
        ...
        try {
            ...
            Assert.assertEquals(10000_0000_0000L - 1024_0000_0000L, accountCapsule.getBalance());
    ...
    public void sameTokenNameCloseSuccessExchangeCreate2() {
        ...
        byte[] ownerAddress = ByteArray.fromHexString(OWNER_ADDRESS_FIRST);
        AccountCapsule accountCapsule = dbManager.getAccountStore().get(ownerAddress);
        accountCapsule.setBalance(200_000_000_0000_0000L);
        ...
        try {
            ...
            accountCapsule = dbManager.getAccountStore().get(ownerAddress);
            Map<String, Long> assetMap = accountCapsule.getAssetMap();
            Assert.assertEquals(200_000_000_0000_0000L - 1024_0000_0000L - firstTokenBalance,
