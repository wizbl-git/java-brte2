...
import com.wizbl.core.capsule.DelegatedResourceCapsule;
...
import com.wizbl.protos.Contract.ResourceCode;
...
public class FreezeBalanceActuatorTest {
    ...
    private static final long initBalance = 10_000_0000_0000L;
    ...
    public void testFreezeBalanceForBandwidth() {
        long frozenBalance = 1_000_0000_0000L;
        long duration = 3;
        ...
        try {
            ...
            Assert.assertEquals(frozenBalance, owner.getBrte2Power());
    ...
    public void testFreezeDelegatedBalanceForBandwidth() {
        ...
        try {
            ...
            Assert.assertEquals(0L, receiver.getBrte2Power());
    ...
    public void freezeMoreThanBalance() {
        long frozenBalance = 11_000_0000_0000L;
        long duration = 3;
        FreezeBalanceActuator actuator = new FreezeBalanceActuator(
                getContractForBandwidth(OWNER_ADDRESS, frozenBalance, duration), dbManager);
        TransactionResultCapsule ret = new TransactionResultCapsule();
    ...
    public void lessThan1TrxTest() {
        ...
        try {
            ...
            Assert.assertTrue(e instanceof ContractValidateException);
            Assert.assertEquals("frozenBalance must be more than 1WBL", e.getMessage());
        } catch (ContractExeException e) {
            Assert.assertFalse(e instanceof ContractExeException);
        }
    }
    ...
    public void frozenNumTest() {
        ...
        account.setFrozen(1000_0000L, 1_000_000_000L);
        account.setFrozen(100_0000_0000L, 1_000_000_000L);
        dbManager.getAccountStore().put(account.getAddress().toByteArray(), account);

        long frozenBalance = 20_0000_0000L;
        long duration = 3L;
        FreezeBalanceActuator actuator = new FreezeBalanceActuator(
                getContractForBandwidth(OWNER_ADDRESS, frozenBalance, duration), dbManager);
        TransactionResultCapsule ret = new TransactionResultCapsule();
