...
import com.wizbl.core.db.api.index.AccountIndex;
import com.wizbl.core.db.api.index.Index;
...
// IndexHelper.java 파일의 구현작업이 정상적으로 마무리 되지 않은 상태임. 이 부분 확인한 후에 처리해야 함.
@Slf4j
public class IndexHelperTest {

    private static final Brte2ApplicationContext context;
    private static final String dbPath = "output_IndexHelper_test";
                        ...
                        Transaction.newBuilder()
                                .setRawData(
                                        Transaction.raw
                                                ...
                                                .build())
                                .build());
        dbManager.getTransactionStore().put(transactionCapsule.getTransactionId().getBytes(), transactionCapsule);
