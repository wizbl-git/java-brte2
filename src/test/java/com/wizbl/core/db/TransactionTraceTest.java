...
public class TransactionTraceTest {
    ...
    private static final String dbPath = "output_TransactionTrace_test";
    private static final String dbDirectory = "db_TransactionTrace_test";
    private static final String indexDirectory = "index_TransactionTrace_test";
    private static final AnnotationConfigApplicationContext context;
    private static final ByteString ownerAddress = ByteString.copyFrom(ByteArray.fromInt(1));
    private static final ByteString contractAddress = ByteString.copyFrom(ByteArray.fromInt(2));
    /*
     ...
     * DeployContract tracetestContract [{"constant":false,"inputs":[{"name":"accountId","type":"uint256"}],"name":"getVoters","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"voters","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"vote","type":"uint256"}],"name":"addVoters","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"inputs":[],"payable":false,"stateMutability":"nonpayable","type":"constructor"}]    1000000000 40
     * */
    private static final String OwnerAddress = "tuzdVmY7n9u1cqFhUcVoTyqDYbGAQayH8qv45T";
    private static final String TriggerOwnerAddress = "tuzdVfP8oD1ekwazAAGCBizRMTaPkmSk8rUFUZ";
    ...
    public void testUseFee()
        ...
        CreateSmartContract smartContract = TVMTestUtils.createSmartContract(Wallet.decodeFromBase58Check(OwnerAddress), contractName, abi, code, 0, 100);
    ...
    public void testUseUsage()
        ...
        trace.exec();
        trace.pay();
        Assert.assertEquals(2050831L, trace.getReceipt().getEnergyUsageTotal()); // getEnergyUsage() -> getEnergyUsageTotal()로 변경
        Assert.assertEquals(0L, trace.getReceipt().getEnergyFee());
        Assert.assertEquals(205083100L,
                trace.getReceipt().getEnergyUsageTotal() * 100 + trace.getReceipt().getEnergyFee());  // getEnergyUsage() -> getEnergyUsageTotal()로 변경
    ...
    public void testTriggerUseFee()
        ...
        trace.exec();
        trace.pay();
        Assert.assertEquals(20252, trace.getReceipt().getEnergyUsageTotal());  // getEnergyUsage() -> getEnergyUsageTotal()로 변경
    ...
    private byte[] deployInit(Transaction transaction)
        ...
        AccountCapsule accountCapsule = new AccountCapsule(
                ByteString.copyFrom("owner".getBytes()),
