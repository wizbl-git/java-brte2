...
public class ManagerTest {
  ...
  private static final String dbPath = "output_manager_test";
...
//            Sha256Hash.wrap(ByteArray.fromHexString(blockCapsule2.getBlockId().toString()))));
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
            new WitnessCapsule(
                    ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.wizbl.com/first");
    witnessCapsulef.setIsJobs(true);
    WitnessCapsule witnessCapsules =
            new WitnessCapsule(
                    ByteString.copyFrom(ByteArray.fromHexString("0x0012")), "www.wizbl.com/second");
    witnessCapsules.setIsJobs(true);
    WitnessCapsule witnessCapsulet =
            new WitnessCapsule(
                    ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.wizbl.com/three");
  ...
  public void fork()
    ...
    String key = "c14b4479e1f8312c493aa1fcb8d483b5a1f67f869568e1684cc765876f57e048";
  ...
  public void doNotSwitch()
    ...
    BlockCapsule blockCapsule3 =
            createTestBlockCapsule(1533529947843L + 3000,
    ...
    BlockCapsule blockCapsule4 =
            createTestBlockCapsule(1533529947843L + 4000,
                    dbManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() + 1,
  ...
  public void testLastHeadBlockIsMaintenance()
    ...
    long size = dbManager.getBlockStore().size();
    System.out.print("block store size:" + size + "\n");
    String key = "c14b4479e1f8312c493aa1fcb8d483b5a1f67f869568e1684cc765876f57e048"; // conf 파일 상의 witness의 private key
    byte[] privateKey = ByteArray.fromHexString(key);
    final ECKey ecKey = ECKey.fromPrivate(privateKey);
    byte[] address = ecKey.getAddress();
    WitnessCapsule witnessCapsule = new WitnessCapsule(ByteString.copyFrom(address));
    dbManager.addWitness(ByteString.copyFrom(address));
    BlockCapsule blockCapsule = dbManager.generateBlock(witnessCapsule, 1533529947843L, privateKey, true);
  ...
  public void switchBack()
    ...
    BlockCapsule blockCapsule0 =
            createTestBlockCapsule(
                    1533529947843L + 1000,  // 1000은 블록 생성 주기임.
                    num + 1,
                    dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getByteString(),
                    addressToProvateKeys);
