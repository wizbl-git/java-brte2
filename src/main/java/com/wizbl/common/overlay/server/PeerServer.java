...
public class PeerServer {
  ...
  public Brte2ChannelInitializer brte2ChannelInitializer;
  ...
  /**
   * NioEventLoop 기반의 PeerServer 객체 실행
   * @param port
   */
  public void start(int port) {
    ...
    brte2ChannelInitializer = ctx.getBean(Brte2ChannelInitializer.class, "");

    brte2ChannelInitializer.setNodeImpl(p2pNode);
    ...
    try {
      ...
      b.childHandler(brte2ChannelInitializer);
