...
import com.wizbl.common.runtime.vm.program.Storage;
...
public class DepositImpl implements Deposit {
  ...
  private final HashMap<Key, Value> accountCache = new HashMap<>();
  private final HashMap<Key, Value> transactionCache = new HashMap<>();
  private final HashMap<Key, Value> blockCache = new HashMap<>();
  private final HashMap<Key, Value> witnessCache = new HashMap<>();
  private final HashMap<Key, Value> codeCache = new HashMap<>();
  private final HashMap<Key, Value> contractCache = new HashMap<>();

  private final HashMap<Key, Value> votesCache = new HashMap<>();
  private final HashMap<Key, Value> proposalCache = new HashMap<>();
  private final HashMap<Key, Value> dynamicPropertiesCache = new HashMap<>();
  private final HashMap<Key, Storage> storageCache = new HashMap<>();
  private final HashMap<Key, Value> assetIssueCache = new HashMap<>();
  ...
  public synchronized void putStorageValue(byte[] address, DataWord key, DataWord value) {
    address = convertToBrte2Address(address);
