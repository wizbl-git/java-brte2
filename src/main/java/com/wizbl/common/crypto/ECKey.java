...
import com.wizbl.common.crypto.jce.*;
...
import static com.wizbl.common.utils.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(AcornCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(
        AcornCastleProvider.getInstance(),
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(AcornCastleProvider.getInstance())
