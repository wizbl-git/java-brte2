 ...
 */
package com.wizbl.common.runtime.vm.trace;

import static java.lang.String.format;
import static com.wizbl.common.runtime.utils.MUtil.convertToBrte2Address;
import static com.wizbl.common.runtime.vm.trace.Serializers.serializeFieldsOnly;
import static com.wizbl.common.utils.ByteUtil.toHexString;
...
import com.wizbl.common.runtime.vm.OpCode;
...
public class ProgramTrace {
    ...
    public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
        if (programInvoke != null && config.vmTrace()) {
            contractAddress = Hex.toHexString(convertToBrte2Address(programInvoke.getContractAddress().getLast20Bytes()));
        }
    }
