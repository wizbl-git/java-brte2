...
import static com.wizbl.common.crypto.Hash.sha3;
import static com.wizbl.common.runtime.utils.MUtil.convertToBrte2Address;
import static com.wizbl.common.runtime.vm.OpCode.CALL;
import static com.wizbl.common.runtime.vm.OpCode.CALLTOKEN;
import static com.wizbl.common.runtime.vm.OpCode.PUSH1;
import static com.wizbl.common.runtime.vm.OpCode.REVERT;
import static com.wizbl.common.runtime.vm.OpCode.TOKENBALANCE;
import static com.wizbl.common.runtime.vm.OpCode.CALLTOKENID;
import static com.wizbl.common.runtime.vm.OpCode.CALLTOKENVALUE;
...
import com.wizbl.common.runtime.vm.program.Stack;
...
public class VM {
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertToBrte2Address(address.getLast20Bytes()))
        == null;
  }
