...
import com.wizbl.common.runtime.vm.program.listener.ProgramListener;
import com.wizbl.common.runtime.vm.program.listener.ProgramListenerAware;
import com.wizbl.common.storage.Deposit;
import com.wizbl.common.storage.Key;
import com.wizbl.common.storage.Value;
...
public class ContractState implements Deposit, ProgramListenerAware {
  ...
  public byte[] getSquirrelAddress() {
    return deposit.getSquirrelAddress();
  }
