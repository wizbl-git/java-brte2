 ...
 */
package com.wizbl.common.runtime.vm.program;

import com.wizbl.common.runtime.config.VMConfig;
import com.wizbl.common.runtime.vm.*;
import com.wizbl.common.runtime.vm.program.invoke.ProgramInvoke;
import com.wizbl.common.runtime.vm.program.invoke.ProgramInvokeFactory;
import com.wizbl.common.runtime.vm.program.invoke.ProgramInvokeFactoryImpl;
import com.wizbl.common.runtime.vm.program.listener.CompositeProgramListener;
import com.wizbl.common.runtime.vm.program.listener.ProgramListenerAware;
import com.wizbl.common.runtime.vm.program.listener.ProgramStorageChangeListener;
import com.wizbl.common.runtime.vm.trace.ProgramTrace;
import com.wizbl.common.runtime.vm.trace.ProgramTraceListener;
import com.wizbl.common.storage.Deposit;
import com.wizbl.common.utils.ByteUtil;
import com.wizbl.common.utils.FastByteComparisons;
import com.wizbl.common.utils.Utils;
import com.wizbl.core.Wallet;
import com.wizbl.core.actuator.TransferActuator;
import com.wizbl.core.actuator.TransferAssetActuator;
...
import static com.wizbl.common.runtime.utils.MUtil.*;
import static com.wizbl.common.utils.BIUtil.isPositive;
import static com.wizbl.common.utils.BIUtil.toBI;
...
public class Program {
  ...
  private final BlockCapsule blockCap;
  ...
  public void suicide(DataWord obtainerAddress) {
    ...
    byte[] owner = convertToBrte2Address(getContractAddress().getLast20Bytes());
    byte[] obtainer = convertToBrte2Address(obtainerAddress.getLast20Bytes());
    ...
    if (FastByteComparisons.compareTo(owner, 0, 20, obtainer, 0, 20) == 0) {
      ...
      byte[] squirrelAddress = getContractState().getSquirrelAddress();
      if (VMConfig.allowTvmTransferTrc10()) {
        getContractState().addBalance(squirrelAddress, balance);
        transferAllToken(getContractState(), owner, squirrelAddress);
      }
    } else {
      try {
  ...
  public void createContract(DataWord value, DataWord memStart, DataWord memSize) {
    ...
    byte[] senderAddress = convertToBrte2Address(this.getContractAddress().getLast20Bytes());
    ...
    if (refundEnergy > 0) {
      ...
      if (logger.isDebugEnabled()) {
        logger.debug("The remaining energy is refunded, account: [{}], energy: [{}] ",
            Hex.toHexString(convertToBrte2Address(getContractAddress().getLast20Bytes())),
            refundEnergy);
      }
    }
  }
  ...
  public void callToAddress(MessageCall msg) {
    ...
    byte[] codeAddress = convertToBrte2Address(msg.getCodeAddress().getLast20Bytes());
    byte[] senderAddress = convertToBrte2Address(getContractAddress().getLast20Bytes());
  ...
  public void storageSave(DataWord word1, DataWord word2) {
    ...
    getContractState()
        .putStorageValue(convertToBrte2Address(getContractAddress().getLast20Bytes()), keyWord,
            valWord);
  }
  ...
  public byte[] getCodeAt(DataWord address) {
    byte[] code = invoke.getDeposit().getCode(convertToBrte2Address(address.getLast20Bytes()));
  ...
  public DataWord getBalance(DataWord address) {
    long balance = getContractState().getBalance(convertToBrte2Address(address.getLast20Bytes()));
  ...
  public DataWord storageLoad(DataWord key) {
    DataWord ret = getContractState()
        .getStorageValue(convertToBrte2Address(getContractAddress().getLast20Bytes()), key.clone());
    return ret == null ? null : ret.clone();
  }

  public DataWord getTokenBalance(DataWord address, DataWord tokenId) {
    long ret = getContractState().getTokenBalance(convertToBrte2Address(address.getLast20Bytes()), String.valueOf(tokenId.longValue()).getBytes());
  ...
  public void callToPrecompiledAddress(MessageCall msg,
    ...
    if (requiredEnergy > msg.getEnergy().longValue()) {
      ...
      contract.setCallerAddress(convertToBrte2Address(msg.getType().callIsDelegate() ?
  ...
  public static class Exception {
    ...
    public static PrecompiledContractException contractValidateException(Brte2Exception e) {
      return new PrecompiledContractException(e.getMessage());
    }

    public static PrecompiledContractException contractExecuteException(Brte2Exception e) {
      return new PrecompiledContractException(e.getMessage());
    }
