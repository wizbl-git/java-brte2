...
import com.wizbl.common.overlay.message.MessageFactory;
 ...
 * msg factory.
 */
public class Brte2MessageFactory extends MessageFactory {

  @Override
  public Brte2Message create(byte[] data) throws Exception {
    try {
      byte type = data[0];
  ...
  private Brte2Message create(byte type, byte[] packed) throws Exception {
    ...
    switch (receivedTypes) {
      ...
      default:
        throw new P2pException(P2pException.TypeEnum.NO_SUCH_MESSAGE,
                receivedTypes + ", len=" + packed.length);
    }
  }
}
