...
import static com.wizbl.core.db2.core.SnapshotManager.simpleDecode;
...
import com.wizbl.common.storage.SourceInter;
...
/**
 * db.version = 2 에서는 해당 클래스를 사용하지 않음.
 */
@Slf4j
...
public abstract class AbstractRevokingStore implements RevokingDatabase {
  ...
  /**
   * LevelDB에서 관리하는 tmp DB를 체크하기 위한 메소드 <br/>
   * db.version = 2 옵션에서는 이 메소드를 호출하지 않음.
   */
  @Override
