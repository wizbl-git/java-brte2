...
import com.wizbl.core.db.api.index.Index.Iface;
import com.wizbl.core.db.common.WrappedByteArray;
import com.wizbl.core.db.common.WrappedResultSet;
...
public abstract class AbstractIndex<E extends ProtoCapsule<T>, T> implements Iface<T> {
  ...
  protected IBrte2ChainBase<E> database;
  ...
  public AbstractIndex(IBrte2ChainBase<E> database) {
