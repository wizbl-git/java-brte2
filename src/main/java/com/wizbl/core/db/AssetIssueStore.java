...
import static com.wizbl.core.config.Parameter.DatabaseConstants.ASSET_ISSUE_COUNT_LIMIT_MAX;
...
@Slf4j
@Component
public class AssetIssueStore extends Brte2StoreWithRevoking<AssetIssueCapsule> {
