...
import com.wizbl.common.entity.NodeInfo.ConfigNodeInfo;
import com.wizbl.common.entity.NodeInfo.MachineInfo;
import com.wizbl.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import com.wizbl.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import com.wizbl.common.entity.PeerInfo;
...
import com.wizbl.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getBrte2LastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getBrte2LastRemoteDisconnectReason();
