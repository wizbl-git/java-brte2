...
//  private CreateWitnessServlet createWitnessServlet;
  ...
  @Autowired
  private SetPrescriptionServlet setPrescriptionServlet;
  @Autowired
  private ListAccountsServlet listAccountsServlet;
  @Autowired
  private Deploy2ContractServlet deploy2ContractServlet;
...
//      context.addServlet(new ServletHolder(createWitnessServlet), "/createwitness");
      ...
      context.addServlet(new ServletHolder(setPrescriptionServlet), "/setprescription");
      context.addServlet(new ServletHolder(listAccountsServlet), "/listaccounts");
      context.addServlet(new ServletHolder(deploy2ContractServlet), "/deploy2contract");
      context.addServlet(
