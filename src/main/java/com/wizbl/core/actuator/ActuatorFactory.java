...
public class ActuatorFactory {
  ...
  /**
   * create actuator. <br/>
   * transactionCapsule에 저장된 contractList의 개별 contract에 해당되는 actuator을 actuatorList에 저장함.
   * @param transactionCapsule
   * @param manager
   * @return actuatorList (contractType에 해당되는 actuator가 저장된 list임)
   */
  public static List<Actuator> createActuator(TransactionCapsule transactionCapsule, Manager manager) {
    ...
    // TODO - 하나의 transactionCapsule 객체에 여러 개의 Contract 타입이 존재할 수 있는 것인가???
