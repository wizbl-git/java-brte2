...
import com.wizbl.core.capsule.utils.TransactionUtil;
...
//      assetIssueCapsule.setOrder(order);
      ...
      dbManager.adjustBalance(dbManager.getAccountStore().getSquirrel().getAddress().toByteArray(),
              fee);//send to squirrel
