...
import com.wizbl.protos.Contract.FreezeBalanceContract;
...
public class FreezeBalanceActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (frozenBalance < 100_000_000L) {
      throw new ContractValidateException("frozenBalance must be more than 1WBL");
    }
