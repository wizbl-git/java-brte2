# Contributing to java-brte2
 
java-brte2 is an open source project.
...
First of all, java-brte2 follows [gitflow workflow](
...
issue](https://github.com/wizbl-git/java-brte2/issues) before anyone
